		...
		<view class="search-box">
			<view class="input-box">
				<input type="text" adjust-position="true" v-model="keyword" :placeholder="defaultKeyword"
					...
					@input="onclear"></input>
				<image src="/static/search/close.png" mode @tap="clears" v-if="shows == true"></image>
			</view>
		...
		<view class="search-keyword">
			...
			<scroll-view class="keyword-box" v-if="!isShowKeywordList" scroll-y>
				<view class="keyword-block" v-if="oldKeywordList.length>0">
					...
					<view class="keyword">
						<view v-for="(item, index) in oldKeywordList" :key="index" @tap="ondoSearch(item)">{{item}}
						</view>
					</view>
				</view>
			</scroll-view>
	...
	export default {
		...
		methods: {
			...
			doSearch() {
				...
				uni.navigateTo({
					url: '/pages/navigation/ShouYe/furniture_shop/classList?content=' + this.keyword
				})
